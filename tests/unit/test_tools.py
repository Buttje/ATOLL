...
class TestMCPToolWrapper:
    ...
    async def test_arun_with_json_input(self):
        ...
        mock_manager.execute_tool.assert_called_once_with(
            server_name="test_server", tool_name="test_tool", arguments={"key": "value"}
        )
    ...
    async def test_arun_with_string_input(self):
        ...
        mock_manager.execute_tool.assert_called_once_with(
            server_name="test_server", tool_name="test_tool", arguments={"input": "plain input"}
        )
...
class TestMCPToolIntegration:
    ...
    def test_tool_creation_from_mcp_definition(self):
        ...
        tool_def = {
            ...
            "parameters": {"file_path": {"type": "string"}, "options": {"type": "object"}},
        }
