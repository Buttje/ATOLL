...
class TestMCPTool:
    ...
    def test_tool_initialization(self):
        ...
        tool = MCPTool(name="test_tool", server="test_server", metadata=metadata)
    ...
    def test_tool_default_description(self):
        ...
        tool = MCPTool(name="test_tool", server="test_server", metadata={})
...
class TestMCPToolRegistry:
    ...
    def test_register_tool_without_name(self):
        ...
        tool_data = {"description": "A test tool"}
    ...
    def test_get_tool(self):
        ...
        tool_data = {"name": "test_tool", "description": "A test tool"}
