...
class AtollInput:
    ...
    async def read_line_async(self, prompt: str = "> ") -> str:
    ...
    def read_line(self, prompt: str = "> ") -> str:
        """Read a line of input from the user synchronously.
    ...
    def get_input(self, prompt: str = "> ", history: list[str] | None = None) -> str:
